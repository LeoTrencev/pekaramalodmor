...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "about.fresh.desc": { mk: "Од раните утрински часови, нашите пекари подготвуваат свежи производи за вас.", en: "From the early morning hours, our bakers prepare fresh products for you." },
